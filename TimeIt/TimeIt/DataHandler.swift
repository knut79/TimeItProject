...
class DataHandler
{
    ...
    func populateData(completePopulating: (() -> (Void))?)
    {
        ...
        newEvent(id++,title:"Pythagoras describes his theorem", year:-532, type:periodType.fivehundred,text:"Pythagoras of Crotona describes the relations between sides of right-angled triangle, and tone vibrations.",tags:"#discovery")
        ...
        newEvent(id++,title:"First seismoscope developed in China", year:132, type:periodType.hundred,tags:"#invention")
        newEvent(id++,title:"First printed newspaper appears in Peking", year:748, type:periodType.hundred,tags:"#invention")
        newEvent(id++,title:"Charlemagne becomes king of the Franks", year:771, type:periodType.hundred,tags:"#headOfState")
        ...
        newEvent(id++,title:"Archimedes explains principles of a lever", year:-212, type:periodType.fivehundred, text:"Area of circle, principles of lever, the screw, and buoyancy.",tags:"#discovery")
        newEvent(id++,title:"Eratosthenes determines the size of Earth", year:-194, type:periodType.fivehundred,tags:"#discovery")
        ...
        newEvent(id++,title:"Leif Ericson lands in North America", year:1000, type:periodType.fifty, text: "The viking Leif Ericson lands in North America, calling it Vinland",tags:"#discovery")
        ...
        newEvent(id++,title:"Marco Polo leaves Venice for China", year:1272, type:periodType.fifty,text:"Marco Polo leaves Venice for China, where he would live and prosper for 17 years, returning to Venice where he died in 1323",tags:"#discovery")
        ...
        newEvent(id++,title:"Columbus discovers the New World", year:1492, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"Vasco da Gama discover sea route to India", year:1497, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"Balboa encounter the Pacific ocean", year:1513, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"Copernicus suggests that the earth moves around the sun", year:1514, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"Coffee from Arabia appears in Europe", year:1515, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"Magellan starts his sail journey", year:1519, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"Potato brought to Europe from South America", year:1540, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"Galileo Galilei discovers Jupiter’s 4 largest moons", year:1610, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"Boyle develops Boyle’s Law", year:1662, type:periodType.fifty, text:"Boyle develops Boyle’s Law: the volume of a gas varies with its pressure",tags:"#discovery")
        newEvent(id++,title:"Isaac Newton experiments with gravity", year:1664, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"Franz Mesmer uses hypnotism", year:1778, type:periodType.fifty, text:"It’s from his name we get the word mesmerized",tags:"#discovery")
        newEvent(id++,title:"Hennig Brand discovers phosphorus", year:1000, type:periodType.fifty, text:"German alchemist Hennig Brand discovers phosphorus, the first new element found since ancient times",tags:"#discovery")
        newEvent(id++,title:"Halley discovers Halley’s comet", year:1682, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"Anthony van Leeuwenhoek discovers bacteria", year:1684, type:periodType.fifty,text:"he significance of which was not understood until the 19th century",tags:"#discovery")
        newEvent(id++,title:"Firsk coffee planted in Brazil", year:1718, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"James Cook discovers Australia", year:1770, type:periodType.fifty,tags:"#discovery")
        newEvent(id++,title:"Michael Faraday discovers benzene", year:1825, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Michael Faraday discovers electromagnetic induction", year:1831, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Rontgen discovers x-rays", year:1894, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Darwin publishes Origin of Species", year:1859, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"JJ Thompson discovers the electron", year:1896, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Planck describing quantum mechanics", year:1900, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Roald Amundsen discovers the magnetic north pole", year:1905, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"First blood transfusion", year:1907, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Leo Baekeland discovers plastic", year:1907, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Einstein proposes quantum theory", year:1908, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Roald Amundsen reaches the South Pole", year:1910, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Alexander Fleming discovers penicillin", year:1928, type:periodType.ten,tags:"#discovery")
        ...
        newEvent(id++,title:"Man reach summit of Mount Everes", year:1953, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Dr Watson discovers the structure of DNA.", year:1953, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Yuri Gagarin the first man in space", year:1961, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Neil Armstrong is the first man on the moon", year:1969, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Viking I lands on Mars", year:1976, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"HIV virus identified", year:1983, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Farman discovers the hole in the ozone", year:1985, type:periodType.ten,tags:"#discovery")
        newEvent(id++,title:"Roslin Institute in Scotland clones a sheep", year:1997, type:periodType.ten,tags:"#discovery")
        
        //INVENTIONS
        ,tags:"#invention"
        
        
        newEvent(id++,title:"Roman calendar introduced", year:-535, type:periodType.fivehundred, text: "It had 10 months, with 304 days in a year that began in March.",tags:"#invention")
        ...
        newEvent(id++,title:"Chinese money printed in 3 colors to stop counterfeit", year:1107, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Magnetic compass invented", year:1182, type:periodType.fifty,text:"The type of ore that attracted iron was known as magnesian stone because it was discovered in Magnesia in Asia Minor. The discovery of the magnet’s use in determining direction was made independently in China and Europe, the latter by English theologian and natural philosopher Alexander Neckam.",tags:"#invention")
        newEvent(id++,title:"Earliest recorded mention of playing cards, found in China.", year:969, type:periodType.hundred,tags:"#invention")
        newEvent(id++,title:"Musical notation systematised.", year:990, type:periodType.hundred,tags:"#invention")
        newEvent(id++,title:"Paper money printed in China.", year:1023, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Buttons invented to decorate clothing", year:1200, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Gun invented in China", year:1250, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"The flioria gold coins created in Florence", year:1252, type:periodType.fifty,text:"It would become the first international currency",tags:"#invention")
        newEvent(id++,title:"The first mention of reading glasses", year:1286, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Drinking chocolate made by Aztecs", year:1350, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Johannes Gutenberg prints the Bible", year:1450, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"First toothbrush made from hog bristles", year:1498, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Coiled springs invented", year:1502, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"First handkerchief used in Europe", year:1503, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"The pencil invented in England", year:1565, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Bottled beer invented in London.", year:1568, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"The barometer is invented", year:1644, type:periodType.fifty, text:"Italian Evangelista Torricelli invents the barometer",tags:"#invention")
        newEvent(id++,title:"A Paris cafe begins serving ice cream", year:1670, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Gabriel Daniel Fahrenheit invents the thermometer", year:1686, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Invention of steam pump", year:1698, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Jethro Tull invents the seed drill", year:1701, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Bartolomeo Cristofori invents the piano", year:1709, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Ketterer invents the cuckoo clock", year:1718, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"The first eraser put on the end of a pencil", year:1752, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"First street lights in New York", year:1761, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"James Hargreaves invents the Spinning Jenny", year:1764, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"James Watt invents rotary steam engine", year:1765, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Nicolas Cugnot builds the motorized carriage", year:1769, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Georges Louis Lesage patents the electric telegraph", year:1774, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Alexander Cummings invents the flush toilet", year:1775, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"William Murdoch invents gas lighting", year:1792, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"The first ambulance used in France", year:1792, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"The first soft drink invented", year:1798, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Alessandro Volta invents the battery", year:1799, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Richard Trevithick builds the steam locomotive.", year:1804, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"William Sturgeon invents the electromagnet", year:1825, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Samuel Mory patents the internal combustion engine", year:1826, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"John Walker invents the modern matches", year:1827, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Louis Braille invents the stereoscope", year:1832, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Franklin Beale invents the coin press", year:1836, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"John Deere patents a steel plow", year:1837, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Samuel Morse introduces the Morse code", year:1837, type:periodType.ten,tags:"#invention")
        ...
        newEvent(id++,title:"John Gorrie invents a refrigerating machine", year:1851, type:periodType.ten,tags:"#invention")
        ...
        newEvent(id++,title:"First Atlantic cable laid", year:1866, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"World’s first traffic light", year:1868, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Suez Canal opens", year:1869, type:periodType.ten,tags:"#invention")
        ...
        newEvent(id++,title:"Graham Bell patents the telephone", year:1876, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Thomas Edison invents the phonograph", year:1877, type:periodType.ten,tags:"#invention")
        ...
        newEvent(id++,title:"World’s first skyscraper", year:1885, type:periodType.ten, text:"10-storey Home Insurance office, built in Chicago",tags:"#invention")
        newEvent(id++,title:"Karl Benz build gasoline-powered car", year:1885, type:periodType.ten,tags:"#invention")
        ...
        newEvent(id++,title:"Orville Wright makes powered flight", year:1903, type:periodType.ten,tags:"#invention")
        ...
        newEvent(id++,title:"First Ford Model T rolls out", year:1908, type:periodType.ten,tags:"#invention")
        ...
        newEvent(id++,title:"Poison gas is used as a weapon", year:1915, type:periodType.ten, text:"Poison gas is used as a weapon in Ypres, Belgium by German forces.",tags:"#invention")
        newEvent(id++,title:"Wireless telephone is invented", year:1919, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Tommy-gun is patented by John T Thompson", year:1920, type:periodType.fifty,tags:"#invention")
        ...
        newEvent(id++,title:"Heinrich Focke creates the first successful helicopter", year:1936, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Supermarket trolleys introduced in Oklahoma", year:1938, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Maiden flight of pressurized airliner", year:00, type:periodType.ten, text:"Boeing Stratoliner",tags:"#invention")
        ...
        newEvent(id++,title:"Velcro is patented", year:1951, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Chrysler introduces power steering", year:1951, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Sony invents pocket-sized transistor radio", year:1952, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Danish toymakers launches Lego", year:1958, type:periodType.ten,tags:"#invention")
        ...
        newEvent(id++,title:"Texas Instruments launches the pocket calculator", year:1972, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Nike running shoes launched", year:1972, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Gillette introduces the disposable razor", year:1974, type:periodType.ten,tags:"#invention")
        ...
        newEvent(id++,title:"Philips invents the CD", year:1980, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"First commercial cell phone call", year:1983, type:periodType.ten,tags:"#invention")
        ...
        newEvent(id++,title:"Wikipedia started", year:2001, type:periodType.ten,tags:"#invention")
        ...
        newEvent(id++,title:"Apple launches the iPhone", year:2007, type:periodType.ten,tags:"#invention")
        newEvent(id++,title:"Apple launches the iPad", year:2010, type:periodType.ten,tags:"#invention")
        
        //HEAD OF STATE
        
        newEvent(id++,title:"Rome founded by Romulus", year:-753, type:periodType.fivehundred,tags:"#headOfState")
        newEvent(id++,title:"Alexander the Great rule Macedonia", from:-336 , to:-323, type:periodType.fivehundred,tags:"#headOfState")
        newEvent(id++,title:"Rule of Cleopatra in Egypt", from:-51, to: -30, type:periodType.fivehundred,tags:"#headOfState")
        newEvent(id++,title:"Julius Caesar assassinated", year:-44, type:periodType.fivehundred,tags:"#headOfState")
        newEvent(id++,title:"Nero becomes last Caesar", year:54, type:periodType.hundred,tags:"#headOfState")
        ...
        newEvent(id++,title:"Emperor Commodus assisinated in Rome", year:193, type:periodType.hundred,tags:"#headOfState")
        newEvent(id++,title:"Dagobert becomes King of the Franks", year:629, type:periodType.hundred,tags:"#headOfState")
        ...
        newEvent(id++,title:"Henry V crowned Holy Roman Emperor", year:1111, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Honorius II is elected pope", year:1124, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Richard I becomes King of England", year:1189, type:periodType.fifty, text:"Known as Coeur de Lion or Richard the Lionheart",tags:"#headOfState")
        newEvent(id++,title:"Richard II made King of England", year:1377, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Henry VI becomes King of England ", year:1429, type:periodType.fifty, text:"He is younger than a year old.",tags:"#headOfState")
        newEvent(id++,title:"Ivan the Great first czar of Russia", year:1462, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Ivan the Terrible (Ivan IV) crowned Czar", year:1547, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Mary Tudor becomes Queen of England", year:1554, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Mary Queen of Scots executed", year:1587, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Peter the Great crowned Czar", year:1689, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"St Petersburg founded by Peter the Great", year:1703, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"George I becomes King of Britain", year:1714, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Louis XV becomes King of France", year:1715, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"George III becomes King of Britain", year:1760, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:" Catherine the Great becomes Czarina", year:1762, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Elias Boudinot elected President of the US", year:1783, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Thomas Mifflin elected President of the US", year:1784, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Richard Henry Lee elected President of the US", year:1785, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Nathan Gorman elected President of the US", year:1786, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Arthur St. Clair elected as President of the US", year:1787, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Cyrus Griffin elected President of the US", year:1788, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"George Washington elected US President", year:1789, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Paul I becomes Tsar of Russia", year:1792, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Napoleon Bonaparte declares himself dictator of France", year:1799, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Napoleon crowns himself Emperor of France", year:1804, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"Napoleon gives crown of Spain to Ferdinand", year:1813, type:periodType.ten,tags:"#headOfState")
        ...
        newEvent(id++,title:"Wellington becomes Prime Minister of Britain", year:1828, type:periodType.ten,tags:"#headOfState")
        ...
        newEvent(id++,title:"Bismarck becomes Prime Minister of Germany", year:1862, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"Gladstone becomes Prime Minister in Britain", year:1868, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"Ulysses S Grant elected US President", year:1868, type:periodType.ten,tags:"#headOfState")
        ...
        newEvent(id++,title:"James Garfield elected US President", year:1880, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"US President Garfield killed", year:1881, type:periodType.ten,text:"Chester Arthur becomes US President",tags:"#headOfState")
        ...
        newEvent(id++,title:"Woodrow Wilson is US president", from:1913, to:1921, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"Adolf Hitler becomes leader of Germany", year:1933, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"Queen Elizabeth II crowned", year:1953, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"Fidel Castro takes power in Cuba", year:1959, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"President John F Kennedy assassinated.", year:1963, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"Yasser Arafat becomes leader of PLO", year:1969, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"Vladimir Putin elected President of Russia", year:2000, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"George W Bush defeats Al Gore to become US President", year:2000, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"Dmitri Medvedev elected President of Russia", year:2008, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"Obama becomes first black US President", year:2009, type:periodType.ten,tags:"#headOfState")
        newEvent(id++,title:"Pope John Paul II dies", year:2005, type:periodType.ten,tags:"#headOfState")
        //WARS
        
        
        newEvent(id++,title: "King David conquers Jerusalem", year:-990, type:periodType.fivehundred,tags:"#war")
        newEvent(id++,title:"The Romans invade Britain", year:-55, type:periodType.fivehundred,tags:"#war")
        newEvent(id++,title:"Angles and Saxons conquer Britain", year:449, type:periodType.hundred,tags:"#war")
        newEvent(id++,title:"Attila the Hun crosses the Rhine into Gaul", year:451, type:periodType.hundred,tags:"#war")
        newEvent(id++,title:"Vandals conquer Rome", year:455, type:periodType.hundred,tags:"#war")
        newEvent(id++,title:"Battle of Vouille", year:507, type:periodType.hundred, text:"Clovis, King of the Franks, defeats the Visigoths at the Battle of Vouille",tags:"#war")
        newEvent(id++,title:"The plague of Europe", from:542, to:593, type:periodType.hundred)
        newEvent(id++,title:"The Lombards invade Italy", year:568, type:periodType.hundred,tags:"#war")
        newEvent(id++,title:"Arabs destroy the city of Carthage", year:695, type:periodType.hundred, text:"Ending Byzantine rule in North Africa",tags:"#war")
        newEvent(id++,title:"Moslem conquest of Spain", year:711, type:periodType.hundred,tags:"#war")
        newEvent(id++,title:"Battle of Tours", year:732, type:periodType.hundred, text:"Frankish forces led by Charles Martel halt the Muslim advance into Europe",tags:"#war")
        newEvent(id++,title:"Charlemagne declares war against the Saxons in Germany", year:748, type:periodType.hundred,tags:"#war")        
        newEvent(id++,title:"Battle of Atlakh", year:751, type:periodType.hundred, text: "Islamic army defeats the Chinese at the Battle of Atlakh, giving Muslims control of the Silk Road.",tags:"#war")
        newEvent(id++,title:"William the Conqueror invades England", year:1066, type:periodType.fifty,text:"William the Conqueror, from Normandy in France, invades England, defeats last Saxon king, Harold II, at Battle of Hastings",tags:"#war")
        newEvent(id++,title:"Pope Urban II calls for holy war", year:1094, type:periodType.fifty,text:"At Council of Clermont, Pope Urban II calls for holy war to wrest Jerusalem from Muslims, launching the First Crusade the next year. Gilbert Crispin’s “A Friendly Disputation” published – a series of discussions on the opposing arguments of faiths between him and a Jew from Mainz.",tags:"#war")
        newEvent(id++,title:"Crusaders capture Jerusalem", year:1099, type:periodType.fifty,tags:"#war")
        newEvent(id++,title:"Vikings invade Ireland", year:795, type:periodType.hundred,tags:"#war")
        newEvent(id++,title:"Second Crusade led by King Louis VIII", year:1145, type:periodType.fifty,tags:"#war")
        newEvent(id++,title:"Moscow built by Prince Yuri Dolgoruky", year:1147, type:periodType.fifty,tags:"#war")
        newEvent(id++,title:"Genghis Khan captures Peking", year:1241, type:periodType.fifty,tags:"#war")
        newEvent(id++,title:"Robert the Bruce´s victory over the English", year:1314, type:periodType.fifty, text:"England bans football (soccer) because it’s too violent. Robert the Bruce leads the Scots to victory over the English at the Battle of Bannockburn",tags:"#war")
        newEvent(id++,title:"The Hundred Years War", from:1337, to:1453, type:periodType.fivehundred,text:"The Hundred Years War begins between kings of England and France for control of France.",tags:"#war")
        newEvent(id++,title:"Joan of Arc leads French against English", year:1428, type:periodType.fifty,tags:"#war")
        newEvent(id++,title:"Wars of the Roses", from:1455, to:1487, type:periodType.fifty,tags:"#war")
                newEvent(id++,title:"The Thirty Years’ War", from:1618, to:1648, type:periodType.fifty, text:"War between Protestants and Catholics begins.",tags:"#war")
        ...
        newEvent(id++,title:"Cromwell invades Ireland", year:1649, type:periodType.fifty,tags:"#war")
        newEvent(id++,title:"Cromwell becomes ruler of England, Scotland and Ireland", year:1653, type:periodType.fifty,tags:"#war")
        newEvent(id++,title:"Battle of Trafalga", year:1805, type:periodType.ten,tags:"#war")
        newEvent(id++,title:"Wellington invades France", year:1813, type:periodType.ten,tags:"#war")
        newEvent(id++,title:"Battle of Waterloo", year:1815, type:periodType.ten,tags:"#war")
                newEvent(id++,title:"The American Civil War", from:1861, to:1865, type:periodType.ten,tags:"#war")
        newEvent(id++,title:"Franco-Prussian war", from:1870, to:1871, type:periodType.ten,tags:"#war")
                newEvent(id++,title:"Battle of Little Big Horn", year:1876, type:periodType.ten,tags:"#war")
                newEvent(id++,title:"Second Boer War", from:1899, to:1902, type:periodType.fifty,tags:"#war")
        newEvent(id++,title:"World War I", from:1914, to:1918, type:periodType.fifty,tags:"#war")
        newEvent(id++,title:"World War II", from:1939, to:1945, type:periodType.fifty,tags:"#war")
                newEvent(id++,title:"Japan’s attack on Pearl Harbor", year:1941, type:periodType.ten,tags:"#war")
        newEvent(id++,title:"Allied D-Day landings at Normandy", year:1944, type:periodType.ten,tags:"#war")
                newEvent(id++,title:"Gulf War erupts as NATO defends Kuwait", year:1990, type:periodType.ten,tags:"#war")
        ...
        newEvent(id++,title:"The Korean War", from:1950, to:1953, type:periodType.ten,tags:"#war")
        newEvent(id++,title:"Vietnam War", from:1954,to:1975, type:periodType.ten,tags:"#war")
newEvent(id++,title:"Russia invades Afghanistan", year:1979, type:periodType.ten,tags:"#war")
        ...
        */
        ...
        newEvent(id++,title:"Great Depression ", from:1929 , to:1939, type:periodType.fifty,level:1)
        newEvent(id++,title:"The Romanesque period", from:1000 , to:1199, type:periodType.fivehundred,level:3)
        newEvent(id++,title:"The Gothic period", from:1150 , to:1450, type:periodType.fivehundred,level:3)
        newEvent(id++,title:"The Humanism cultural period", from:1500 , to:1599, type:periodType.fivehundred,level:3)
        newEvent(id++,title:"The European Renaissance", from:1300 , to:1699, type:periodType.fivehundred,level:2)
