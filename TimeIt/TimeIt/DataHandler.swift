...
class DataHandler
{
    ...
    func populateData(completePopulating: (() -> (Void))?)
    {
        ...
        newEvent(id++,title:"First Olympiad in Greece", year:-776, type:periodType.fivehundred,level:2,tags:"#miscellaneous#sport")
        newEvent(id++,title:"Aesop’s fables thought to be written", year:-990, type:periodType.fivehundred,tags:"#miscellaneous")
        
        newEvent(id++,title:"Buddha born in India.", year:-563, type:periodType.fivehundred,tags:"#miscellaneous")
        newEvent(id++,title:"Confucius born in China", year:-551, type:periodType.fivehundred,tags:"#miscellaneous")
        newEvent(id++,title:"Rome as a Republic founded", year:-500, type:periodType.fivehundred, text:"End of monarchy in Rome", level:1, tags:"#miscellaneous")
        newEvent(id++,title:"Socrates drink hemlock", year:-399, type:periodType.fivehundred, text:"Socrates is required to drink hemlock to end his life after being found guilty of corrupting the youth of Athens",level:2,tags:"#miscellaneous")
        newEvent(id++,title:"Persian empire", from:-550 , to:-330, type:periodType.fivehundred,level:1,tags:"#miscellaneous")
        newEvent(id++,title:"Livius Andronicus is the first Roman poet", year:-240, type:periodType.fivehundred,tags:"#miscellaneous")
        newEvent(id++,title:"Solomon builds the Temple in Jerusalem", year:-950, type:periodType.fivehundred,tags:"#miscellaneous")
        newEvent(id++,title:"Founding of Constantinople", year:330, type:periodType.hundred,tags:"#miscellaneous")
        newEvent(id++,title:"Library of Alexandria is destroyed by fire", year:391, type:periodType.hundred,tags:"#miscellaneous")
        newEvent(id++,title:"Muhammad the Prophet dies", year:632, type:periodType.hundred,level:1,tags:"#miscellaneous")
        newEvent(id++,title:"Vikings settle in Iceland", year:874, type:periodType.hundred,tags:"#miscellaneous")
        newEvent(id++,title:"The Capetian dynasty", from:987 , to:1328, type:periodType.hundred,tags:"#miscellaneous")
        ...
        newEvent(id++,title:"Prohibition in the United States", from:1920, to:1933, type:periodType.ten,level:1,tags:"#miscellaneous")
        ...
        newEvent(id++,title:"Aristotle writes Meteorologica", year:-990, type:periodType.fivehundred,text: "The first book on weather.",tags:"#science")
        newEvent(id++,title:"Musa al-Kwarizmi born in Baghdad", year:780, type:periodType.hundred, text:"He introduced Hindu-Arabic numerals in his book Kitab al-jabr wa al-mugabalah.",tags:"#science")
        newEvent(id++,title:"Shen Kua of China writes about the magnetic compass", year:1086, type:periodType.fifty,level:2,tags:"#science")
        newEvent(id++,title:"First modern university", year:1088, type:periodType.fifty, text: "First modern university established in Bologna, Italy",tags:"#science")
        newEvent(id++,title:"Map of western China printed", year:1162, type:periodType.fifty, text:"Oldest known printed map",tags:"#science")
        newEvent(id++,title:"University of Oxford founded", year:1249, type:periodType.fifty,level:1,tags:"#science")
        newEvent(id++,title:"University of Cambridge founded", year:1284, type:periodType.fifty,level:2,tags:"#science")
        newEvent(id++,title:"Fire destroys four-fifths of London", year:1666, type:periodType.fifty,level:1, tags:"#science")
        newEvent(id++,title:"Leonardo da Vinci born", year:1452, type:periodType.fifty,level:1,tags:"#science")
        newEvent(id++,title:"Copernicus born in Poland", year:1473, type:periodType.fifty,level:1,tags:"#science")
        newEvent(id++,title:"Kepler publishes Mysterium cosmographicum", year:1596, type:periodType.fifty,level:2,tags:"#science")
        newEvent(id++,title:"Inquisition forces Galileo to recant his belief", year:1633, type:periodType.fifty, text:"Inquisition forces Galileo to recant his belief in Copernican theory.",level:2,tags:"#science")
        ...
        newEvent(id++,title:"Pythagoras describes his theorem", year:-532, type:periodType.fivehundred,text:"Pythagoras of Crotona describes the relations between sides of right-angled triangle, and tone vibrations.",level:2,tags:"#discovery#science")
        newEvent(id++,title:"Archimedes explains principles of a lever", year:-212, type:periodType.fivehundred, text:"Area of circle, principles of lever, the screw, and buoyancy.",tags:"#discovery#science")
        newEvent(id++,title:"Eratosthenes determines the size of Earth", year:-194, type:periodType.fivehundred,tags:"#discovery#science")
        ...
        newEvent(id++,title:"Leif Ericson lands in North America", year:1000, type:periodType.fifty, text: "The viking Leif Ericson lands in North America, calling it Vinland",level:2,tags:"#discovery")
        newEvent(id++,title:"Marco Polo leaves Venice for China", year:1272, type:periodType.fifty,text:"Marco Polo leaves Venice for China, where he would live and prosper for 17 years, returning to Venice where he died in 1323",level:2,tags:"#discovery")
        newEvent(id++,title:"Columbus discovers the New World", year:1492, type:periodType.fifty,level:1,tags:"#discovery")
        newEvent(id++,title:"Vasco da Gama discover sea route to India", year:1497, type:periodType.fifty,level:1,tags:"#discovery")
        newEvent(id++,title:"Balboa encounter the Pacific ocean", year:1513, type:periodType.fifty,level:2,tags:"#discovery")
        newEvent(id++,title:"Copernicus suggests that the earth moves around the sun", year:1514, type:periodType.fifty,level:2,tags:"#discovery")
        newEvent(id++,title:"Coffee from Arabia appears in Europe", year:1515, type:periodType.fifty,level:2,tags:"#discovery")
        newEvent(id++,title:"Magellan starts his sail journey", year:1519, type:periodType.fifty,level:2,tags:"#discovery")
        ...
        newEvent(id++,title:"Boyle develops Boyle’s Law", year:1662, type:periodType.fifty, text:"Boyle develops Boyle’s Law: the volume of a gas varies with its pressure",level:2,tags:"#discovery")
        newEvent(id++,title:"Isaac Newton experiments with gravity", year:1664, type:periodType.fifty,tags:"#discovery#science")
        ...
        newEvent(id++,title:"Halley discovers Halley’s comet", year:1682, type:periodType.fifty,level:2,tags:"#discovery#science")
        newEvent(id++,title:"Anthony van Leeuwenhoek discovers bacteria", year:1684, type:periodType.fifty,text:"he significance of which was not understood until the 19th century",tags:"#discovery#science")
        newEvent(id++,title:"First coffee planted in Brazil", year:1718, type:periodType.fifty,tags:"#discovery#science")
        newEvent(id++,title:"James Cook discovers Australia", year:1770, type:periodType.fifty,level:1,tags:"#discovery")
        ...
        newEvent(id++,title:"Roman calendar introduced", year:-535, type:periodType.fivehundred, text: "It had 10 months, with 304 days in a year that began in March.",level:2,tags:"#invention")
        ...
        newEvent(id++,title:"The flioria gold coins created in Florence", year:1252, type:periodType.fifty,text:"It would become the first international currency",level:2,tags:"#invention")
        newEvent(id++,title:"The first mention of reading glasses", year:1286, type:periodType.fifty,level:2,tags:"#invention")
        newEvent(id++,title:"Drinking chocolate made by Aztecs", year:1350, type:periodType.fifty,level:2,tags:"#invention")
        ...
        newEvent(id++,title:"Coiled springs invented", year:1502, type:periodType.fifty,level:1,tags:"#invention")
        newEvent(id++,title:"First handkerchief used in Europe", year:1503, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"The pencil invented in England", year:1565, type:periodType.fifty,level:1,tags:"#invention")
        newEvent(id++,title:"Bottled beer invented in London.", year:1568, type:periodType.fifty,level:2,tags:"#invention")
        newEvent(id++,title:"The first mechanical calculator", year:1623, type:periodType.fifty, text:"German inventor Wilhelm Schickard invents the first mechanical calculator. Records detailing the machine’s workings were lost during the Thirty Years’ War.",level:2,tags:"#invention")
        newEvent(id++,title:"The barometer is invented", year:1644, type:periodType.fifty, text:"Italian Evangelista Torricelli invents the barometer",level:1,tags:"#invention")
        newEvent(id++,title:"A Paris cafe begins serving ice cream", year:1670, type:periodType.fifty,tags:"#invention")
        newEvent(id++,title:"Gabriel Daniel Fahrenheit invents the thermometer", year:1686, type:periodType.fifty,level:2,tags:"#invention")
        newEvent(id++,title:"Invention of steam pump", year:1698, type:periodType.fifty,level:1,tags:"#invention")
        ...
        newEvent(id++,title:"First street lights in New York", year:1761, type:periodType.fifty,level:2,tags:"#invention")
        newEvent(id++,title:"James Hargreaves invents the Spinning Jenny", year:1764, type:periodType.fifty,level:2,tags:"#invention")
        newEvent(id++,title:"James Watt invents rotary steam engine", year:1765, type:periodType.fifty,level:1,tags:"#invention")
        newEvent(id++,title:"Nicolas Cugnot builds the motorized carriage", year:1769, type:periodType.fifty,level:1,tags:"#invention")
        newEvent(id++,title:"Georges Louis Lesage patents the electric telegraph", year:1774, type:periodType.fifty,level:1,tags:"#invention")
        newEvent(id++,title:"Alexander Cummings invents the flush toilet", year:1775, type:periodType.fifty,level:2,tags:"#invention")
        ...
        newEvent(id++,title:"Alessandro Volta invents the battery", year:1799, type:periodType.fifty,level:2,tags:"#invention")
        ...
        //HEAD OF STATE
        newEvent(id++,title:"Babylon ruled by Nebuchadnezzar", from: -605, to: -562, type:periodType.fivehundred,level:2,tags:"#headOfState")
        newEvent(id++,title:"Rome founded by Romulus", year:-753, type:periodType.fivehundred,tags:"#headOfState")
        newEvent(id++,title:"Alexander the Great rule Macedonia", from:-336 , to:-323, type:periodType.fivehundred,level:1,tags:"#headOfState")
        newEvent(id++,title:"Rule of Cleopatra in Egypt", from:-51, to: -30, type:periodType.fivehundred,level:2,tags:"#headOfState")
        newEvent(id++,title:"Julius Caesar assassinated", year:-44, type:periodType.fivehundred,level:1,tags:"#headOfState")
        newEvent(id++,title:"Nero becomes last Caesar", year:54, type:periodType.hundred,level:2,tags:"#headOfState")
        ...
        newEvent(id++,title:"Henry V crowned Holy Roman Emperor", year:1111, type:periodType.fifty,level:2,tags:"#headOfState")
        newEvent(id++,title:"Honorius II is elected pope", year:1124, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Richard I becomes King of England", year:1189, type:periodType.fifty, text:"Known as Coeur de Lion or Richard the Lionheart",level:1,tags:"#headOfState")
        ...
        newEvent(id++,title:"Ivan the Great first czar of Russia", year:1462, type:periodType.fifty,level:1,tags:"#headOfState")
        newEvent(id++,title:"Ivan the Terrible (Ivan IV) crowned Czar", year:1547, type:periodType.fifty,level:1,tags:"#headOfState")
        newEvent(id++,title:"Mary Tudor becomes Queen of England", year:1554, type:periodType.fifty,level:1,tags:"#headOfState")
        newEvent(id++,title:"Mary Queen of Scots executed", year:1587, type:periodType.fifty,level:2,tags:"#headOfState")
        newEvent(id++,title:"Peter the Great crowned Czar", year:1689, type:periodType.fifty,level:1,tags:"#headOfState")
        newEvent(id++,title:"St Petersburg founded by Peter the Great", year:1703, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"George I becomes King of Britain", year:1714, type:periodType.fifty,level:2,tags:"#headOfState")
        ...
        newEvent(id++,title:"Catherine the Great becomes Czarina", year:1762, type:periodType.fifty,level:2,tags:"#headOfState")
        ...
        newEvent(id++,title:"George Washington elected US President", year:1789, type:periodType.fifty,level:1,tags:"#headOfState")
        newEvent(id++,title:"Paul I becomes Tsar of Russia", year:1792, type:periodType.fifty,tags:"#headOfState")
        newEvent(id++,title:"Napoleon Bonaparte declares himself dictator of France", year:1799, type:periodType.fifty,level:2,tags:"#headOfState")
        ...
        newEvent(id++,title:"Woodrow Wilson is US president", from:1913, to:1921, type:periodType.ten,level:2,tags:"#headOfState")
        ...
        newEvent(id++,title:"Herbert Hoover is US president", from:1929, to:1933, type:periodType.ten,tags:"#headOfState")
        
        newEvent(id++,title:"Franklin D. Roosevelt is US president", from:1933, to:1945, type:periodType.ten,level:1,tags:"#headOfState")
        newEvent(id++,title:"Harry Truman is US president", from:1945, to:1953, type:periodType.ten,level:2,tags:"#headOfState")
        newEvent(id++,title:"Dwight Eisenhower is US president", from:1953, to:1961, type:periodType.ten,level:2,tags:"#headOfState")
        ...
        newEvent(id++,title:"Joseph Stalin is leader of USSR", from:1924, to:1953, type:periodType.ten,level:1,tags:"#headOfState")
        newEvent(id++,title:"Nikita Khrushchev is leader of USSR", from:1955, to:1964, type:periodType.ten,level:2,tags:"#headOfState")
        newEvent(id++,title:"Leonid Brezhnev is leader of USSR", from:1964, to:1982, type:periodType.ten,level:2,tags:"#headOfState")
        ...
        newEvent(id++,title:"The Romans invade Britain", year:-55, type:periodType.fivehundred,level:2,tags:"#war")
        newEvent(id++,title:"Angles and Saxons conquer Britain", year:449, type:periodType.hundred,level:2,tags:"#war")
        newEvent(id++,title:"Attila the Hun crosses the Rhine into Gaul", year:451, type:periodType.hundred,tags:"#war")
        newEvent(id++,title:"Vandals conquer Rome", year:455, type:periodType.hundred,level:2,tags:"#war")
        ...
        newEvent(id++,title:"Robert the Bruce´s victory over the English", year:1314, type:periodType.fifty, text:"Robert the Bruce leads the Scots to victory over the English at the Battle of Bannockburn",tags:"#war")
        newEvent(id++,title:"The Hundred Years War", from:1337, to:1453, type:periodType.fivehundred,text:"The Hundred Years War begins between kings of England and France for control of France.",level:1,tags:"#war")
        newEvent(id++,title:"Joan of Arc leads French against English", year:1428, type:periodType.fifty,level:2,tags:"#war")
        ...
        newEvent(id++,title:"World War I", from:1914, to:1918, type:periodType.fifty,level:1,tags:"#war")
        ...
        newEvent(id++,title:"Vietnam War", from:1954,to:1975, type:periodType.ten,level:1,tags:"#war")
        newEvent(id++,title:"Russia invades Afghanistan", year:1979, type:periodType.ten,level:2,tags:"#war")

        newEvent(id++,title:"Bay of Pigs Invasion", from:1961, to: 1961, type:periodType.ten,level:1,tags:"#war")
        newEvent(id++,title:"Iran Iraq War",from:1980 , to:1988 , type:periodType.ten,tags:"#war")
        newEvent(id++,title:"Falklands War", from:1982, to: 1982, type:periodType.ten,level:2,tags:"#war")
        ...
        newEvent(id++,title:"Chinese Civil War", from:1927 , to:1949, type:periodType.ten,tags:"#war")
        ...
        newEvent(id++,title:"Russian Civil War",from:1917 , to:1923 , type:periodType.ten,level:2,tags:"#war")
        newEvent(id++,title:"Mexican Revolution", from:1910 , to:1921, type:periodType.ten,tags:"#war")
        newEvent(id++,title:"French Revolution", from:1789, to:1799, type:periodType.fifty,level:1,tags:"#war")
